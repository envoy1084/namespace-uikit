...
| `label`            | `string`    | `Transaction confirmation in progress` | Accessible progress-bar label.                                      |
| `linkLabel`        | `string`    | `Check on Etherscan`                   | Visible explorer-link label.                                        |
...
The progress fill and icon stop animating when the user prefers reduced motion.
