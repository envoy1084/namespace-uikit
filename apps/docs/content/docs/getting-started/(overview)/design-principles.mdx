...
description: Core principles that guide Namespace UIKit's design and development
icon: book
---

Namespace UIKit follows 10 core principles that prioritize clarity, accessibility, customization, and developer experience.
...
<DocsImage
  src="/assets/getting-started/emphasis.jpg"
  darkSrc="/assets/getting-started/emphasis-dark.jpg"
...
```tsx
import { Tabs, TabList, Tab, TabPanel } from "@thenamespace/uikit";
...
import { Alert, AlertIcon, CardHeader, AccordionTrigger } from '@thenamespace/uikit';
...
Styles (`@thenamespace/uikit/styles`) are separate from logic (`@thenamespace/uikit`), enabling use with any framework or vanilla HTML. See [Tailwind Play example](https://play.tailwindcss.com/vMYXzKPyUx).
...
// Apply Namespace UIKit's BEM classes directly to any element
...
## Comparison with Namespace UIKit v2

| Aspect                       | Namespace UIKit v2                   | Namespace UIKit                           |
| ---------------------------- | ------------------------------------ | ----------------------------------------- |
