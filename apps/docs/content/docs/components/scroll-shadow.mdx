...
links:
  ...
  storybook: Components/Layout/ScrollShadow
  figma: true
---
...
```tsx
import { ScrollShadow, Card } from "@thenamespace/uikit";
...
The ScrollShadow component uses these CSS classes ([View source styles](https://github.com/thenamespace/uikit/blob/main/packages/uikit/src/styles/components/scroll-shadow.css)):
