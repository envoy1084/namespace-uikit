...
```tsx
import { Toast, toast } from "@thenamespace/uikit";
```
...
```tsx
import { Toast, Button, toast } from "@thenamespace/uikit";
...
<ComponentPreview name="toast-custom-indicator" />
...
<ComponentPreview name="toast-callbacks" />

### Placements

<ComponentPreview name="toast-placements" />

### Custom Toast Rendering

<ComponentPreview name="toast-custom-toast" />

### Custom Queues

<ComponentPreview name="toast-custom-queue" />
...
The Toast component uses these CSS classes ([View source styles](https://github.com/thenamespace/uikit/blob/main/packages/uikit/src/styles/components/toast.css)):
