...
<!-- PRO_DEMO emoji-reaction-button-default -->
<ComponentPreview name="emoji-reaction-button-default" />
...
<!-- PRO_DEMO emoji-reaction-button-disabled -->
<ComponentPreview name="emoji-reaction-button-disabled" />

## Read-only

<!-- PRO_DEMO emoji-reaction-button-read-only -->
<ComponentPreview name="emoji-reaction-button-read-only" />

## Sizes

<!-- PRO_DEMO emoji-reaction-button-sizes -->
<ComponentPreview name="emoji-reaction-button-sizes" />
