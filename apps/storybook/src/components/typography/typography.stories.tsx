...
export const InlineCode: Story = {
  render: () => (
    <div className="flex max-w-2xl flex-col gap-4">
      <Typography.Paragraph>
        Install the package with <Typography.Code>pnpm add @thenamespace/uikit</Typography.Code> and
  ...
  render: () => (
    <article className="flex max-w-2xl flex-col gap-4">
      ...
      <Typography.Paragraph>
        ...
        standard — and derive heading sizes using a consistent ratio. Namespace uses a
        tracking-tight heading stack from <Typography.Code>text-base</Typography.Code> through{" "}
      ...
      <Typography.Paragraph color="muted" size="sm">
        ...
        readability. These defaults work out of the box with Namespace's Typography primitive.
      </Typography.Paragraph>
    </article>
  ),
};
  ...
  render: () => (
    <Typography.Prose className="max-w-2xl">
      ...
      <p>
        ...
        <strong>Tailwind CSS v4</strong> and <strong>React Aria</strong>. It provides accessible,
        customizable primitives that you can compose into complex interfaces.
      </p>

      <h2>Installation</h2>
      <p>
        Add the library to your project using your preferred package manager. The{" "}
        <code>@thenamespace/uikit</code> package includes every component:
      </p>
      <pre>
      ...
      <h2>Next Steps</h2>
      <p>
        Explore the <a href="https://namespace.ninja">component stories</a> in Storybook to see
        every variant and composition in action. Each component ships with comprehensive
