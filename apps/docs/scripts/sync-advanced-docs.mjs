...
function adaptPage(raw, slug) {
  ...
  if (!page)
    throw new Error(`Invalid upstream documentation response for ${slug}`);
...
await import("./build-demo-registry.mjs");

console.log(`Synced ${componentUrls.size} authoritative component pages.`);
