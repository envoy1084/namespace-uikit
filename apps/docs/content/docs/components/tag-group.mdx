...
```tsx
import { TagGroup } from "@thenamespace/uikit";
```
...
<ComponentPreview name="tag-group-with-list-data" />

### Custom Render Function

<ComponentPreview name="tag-group-custom-render-function" />
...
```tsx
import { TagGroup, Tag, Label } from "@thenamespace/uikit";
...
The TagGroup component uses these CSS classes ([View source styles](https://github.com/thenamespace/uikit/blob/main/packages/uikit/src/styles/components/tag-group.css) and [tag.css](https://github.com/thenamespace/uikit/blob/main/packages/uikit/src/styles/components/tag.css)):
