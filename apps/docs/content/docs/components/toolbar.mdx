...
```tsx
import { Toolbar } from "@thenamespace/uikit";
```
...
The Toolbar component uses these CSS classes ([View source styles](https://github.com/thenamespace/uikit/blob/main/packages/uikit/src/styles/components/toolbar.css)):
