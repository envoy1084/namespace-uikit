...
```tsx
import { Meter, Label } from "@thenamespace/uikit";
```
...
The Meter component uses these CSS classes ([View source styles](https://github.com/thenamespace/uikit/blob/main/packages/uikit/src/styles/components/meter.css)):
