...
<ComponentPreview name="color-area-with-dots" />

### Controlled

<ComponentPreview name="color-area-controlled" />
...
<ComponentPreview name="color-area-space-and-channels" />

### Disabled

<ComponentPreview name="color-area-disabled" />

### Custom Render Function

<ComponentPreview name="color-area-custom-render-function" />
...
The ColorArea component uses these CSS classes ([View source styles](https://github.com/thenamespace/uikit/blob/main/packages/uikit/src/styles/components/color-area.css)):
