...
```tsx
import { Card } from '@thenamespace/uikit';
import { cardVariants } from '@thenamespace/uikit/styles';
...
Card uses [BEM](https://getbem.com/) naming for predictable styling, ([View source styles](https://github.com/thenamespace/uikit/blob/main/packages/uikit/src/styles/components/card.css)):
