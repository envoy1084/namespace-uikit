...
```tsx
import { DateField } from "@thenamespace/uikit";
```
...
```tsx
import { DateField, Label, Description, FieldError } from "@thenamespace/uikit";
...
<ComponentPreview name="date-field-custom-render-function" />
...
```tsx
import { DateField, Label, Description } from "@thenamespace/uikit";
...
- **DateField.Input** - Input component with segmented editing from `@thenamespace/uikit`
