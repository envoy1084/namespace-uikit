...
{/* PRO_DEMO chat-source-default */}
<ComponentPreview name="chat-source-default" />

Use `ChatSource` to cite a URL or uploaded document inline with an assistant answer.

## Document

{/* PRO_DEMO chat-source-document */}
<ComponentPreview name="chat-source-document" />

Set `sourceType="document"` for uploaded or local files.

## Grouped

{/* PRO_DEMO chat-source-grouped */}
<ComponentPreview name="chat-source-grouped" />

Use `ChatSources` to group multiple citations behind a collapsible trigger.

## Stacked Favicons

{/* PRO_DEMO chat-source-stacked-favicons */}
<ComponentPreview name="chat-source-stacked-favicons" />

For a compact source button, render stacked favicon avatars in the `ChatSources.Trigger`.

## Composable

{/* PRO_DEMO chat-source-composable */}
<ComponentPreview name="chat-source-composable" />
