...
import { RegistrationPayment } from "#/components/name-registration/steps/registration-process/steps/registration-payment";
    ...
    >
      ...
      <Accordion.Panel>
        <Accordion.Body>
          ...
          >
            Your name is not registered yet. Complete the final transaction before your commitment
            expires to claim it.
          </Typography.Paragraph>
          <RegistrationPayment
