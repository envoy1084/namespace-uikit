...
// @demo-title Agent Trace Streaming
      ...
      <TraceSection isStreaming={isStreaming} title="Generated design">
        <ChainOfThought.Step>
          <img
            ...
            src="/assets/docs/pro-related-components/light-areaChart.png"
          />
        </ChainOfThought.Step>
      </TraceSection>
...
export const ProAgentTraceStreamingExample = () => (
  <AgentTraceDemo isStreaming />
);
