...
<!-- PRO_DEMO rich-text-editor-default -->
...
<!-- PRO_DEMO rich-text-editor-controlled -->
<ComponentPreview name="rich-text-editor-controlled" />

## Character Count

<!-- PRO_DEMO rich-text-editor-character-count -->
<ComponentPreview name="rich-text-editor-character-count" />

## Placeholder

<!-- PRO_DEMO rich-text-editor-placeholder -->
...
<!-- PRO_DEMO rich-text-editor-custom-composition -->
...
<!-- PRO_DEMO rich-text-editor-disabled -->
<ComponentPreview name="rich-text-editor-disabled" />

### Extensible

<!-- PRO_DEMO rich-text-editor-extensible -->
