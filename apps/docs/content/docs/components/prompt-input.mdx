...
<!-- PRO_DEMO prompt-input-default -->
<ComponentPreview name="prompt-input-default" />

Use `PromptInput` as the message composer for chat and agent interfaces.

## Secondary

<!-- PRO_DEMO prompt-input-secondary -->
<ComponentPreview name="prompt-input-secondary" />

Use the secondary variant when the composer sits on a default surface.

## Inline

<!-- PRO_DEMO prompt-input-inline -->
<ComponentPreview name="prompt-input-inline" />
...
<!-- PRO_DEMO prompt-input-compact -->
<ComponentPreview name="prompt-input-compact" />
...
<!-- PRO_DEMO prompt-input-review-composer -->
<ComponentPreview name="prompt-input-review-composer" />

Compose `PromptInput` with workflow controls to build compact agent surfaces such as review follow-ups and commit actions.

## With Suggestions

<!-- PRO_DEMO prompt-input-with-suggestions -->
<ComponentPreview name="prompt-input-with-suggestions" />

Compose `PromptInput` with `PromptSuggestion` to create a landing-style composer with quick-start prompts.

## Run State

<!-- PRO_DEMO prompt-input-run-state -->
<ComponentPreview name="prompt-input-run-state" />

Prompt input supports `submitted`, `streaming`, `ready`, and `error` states for send/stop behavior.

## Queue

<!-- PRO_DEMO prompt-input-queue -->
<ComponentPreview name="prompt-input-queue" />
