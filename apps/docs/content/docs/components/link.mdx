...
<ComponentPreview name="link-custom-render-function" />
...
The Link component uses these CSS classes ([View source styles](https://github.com/thenamespace/uikit/blob/main/packages/uikit/src/styles/components/link.css)):
...
Since Namespace UIKit uses [BEM](https://getbem.com/) classes, you can apply Link styles directly to any link element:
...
export default function NativeLink() {
  return (
    <a
      href="/about"
      className="link underline decoration-primary underline-offset-4"
    >
      About Page
