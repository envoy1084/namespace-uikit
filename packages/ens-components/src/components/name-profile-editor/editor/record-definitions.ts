...
const generalRecords = [
  ...
  defineRecord("general", "text", "description", "Short bio", "Making the world a better place"),
  defineRecord("general", "text", "url", "Website", "https://piedpiper.com"),
  defineRecord("general", "text", "location", "Location", "Palo Alto, CA"),
  defineRecord("general", "text", "timezone", "Timezone", "America/Los_Angeles"),
  defineRecord("general", "text", "email", "E-mail", "richard@piedpiper.com"),
  defineRecord("general", "text", "notice", "Notice", "Official updates from this name"),
  defineRecord("general", "text", "keywords", "Keywords", "technology, software, identity"),
  defineRecord("general", "text", "avatar", "Avatar", "ipfs://bafybeigdyrzt5sfp…di7kiv7wq"),
  defineRecord("general", "text", "header", "Header", "https://piedpiper.com/header.png"),
...
const socialRecords = [
  ...
  defineRecord("social", "text", "org.telegram", "Telegram", "richard_hendricks"),
  ...
  defineRecord("social", "text", "com.linkedin", "LinkedIn", "richard-hendricks"),
  defineRecord("social", "text", "com.reddit", "Reddit", "piedpiper"),
  defineRecord("social", "text", "com.tiktok", "TikTok", "@piedpiper"),
  defineRecord("social", "text", "com.mastodon", "Mastodon", "@richard@techhub.social"),
  defineRecord("social", "text", "com.bluesky", "Bluesky", "richard.piedpiper.com"),
] as const;

const evmAddressPlaceholder = "0xA0b86991…3606eB48";

const addressRecords = [
  defineRecord("addresses", "address", "2147483648", "Default", evmAddressPlaceholder),
  ...
  defineRecord("addresses", "address", "2147492101", "Base", evmAddressPlaceholder),
  defineRecord("addresses", "address", "2147525809", "Arbitrum", evmAddressPlaceholder),
  defineRecord("addresses", "address", "2147483658", "Optimism", evmAddressPlaceholder),
  defineRecord("addresses", "address", "2147483785", "Polygon", evmAddressPlaceholder),
  defineRecord("addresses", "address", "2147483704", "BNB Chain", evmAddressPlaceholder),
  defineRecord("addresses", "address", "2147526762", "Avalanche", evmAddressPlaceholder),
  defineRecord("addresses", "address", "2147525868", "Celo", evmAddressPlaceholder),
  defineRecord("addresses", "address", "2147483898", "Fantom", evmAddressPlaceholder),
  defineRecord("addresses", "address", "2147484736", "Metis", evmAddressPlaceholder),
  defineRecord("addresses", "address", "2155261425", "Zora", evmAddressPlaceholder),
  defineRecord("addresses", "address", "2147483748", "Gnosis", evmAddressPlaceholder),
  defineRecord("addresses", "address", "2148018000", "Scroll", evmAddressPlaceholder),
  defineRecord("addresses", "address", "2147542792", "Linea", evmAddressPlaceholder),
  defineRecord("addresses", "address", "2147483972", "zkSync Era", evmAddressPlaceholder),
  ...
  defineRecord("addresses", "address", "145", "Bitcoin Cash", "bitcoincash:qp63uahg…spdc2h"),
...
const websiteRecords = [
  defineRecord("website", "contenthash", "ipfs", "IPFS", "ipfs://bafybeigdyrzt5sfp…di7kiv7wq"),
  defineRecord("website", "contenthash", "ipns", "IPNS", "ipns://k51qzi5uqu5dl7t5…6qlwyx"),
  defineRecord("website", "contenthash", "arweave", "Arweave", "arweave://j7W9FZ4d…eR4pJQ"),
  defineRecord("website", "contenthash", "swarm", "Swarm", "swarm://d1de9994c2a6…9d61c0"),
  defineRecord("website", "contenthash", "onion", "Tor v2", "onion://expyuzz4wqqy…yqhjn"),
  defineRecord("website", "contenthash", "onion3", "Tor v3", "onion3://2gzyxa5ihm7n…d.onion"),
  defineRecord("website", "contenthash", "skynet", "Skynet", "skynet://AAC_O9R3…61_fN0"),
  defineRecord("website", "contenthash", "adnl", "TON", "adnl://UQCwBymK…T7f9kQ"),
] as const;

const advancedRecords = [
  defineRecord("advanced", "text", "eth.ens.delegate", "ENS delegate", "delegate.eth"),
  ...
  defineRecord("advanced", "interface", "interface", "Interface", evmAddressPlaceholder, {
    isRepeatable: true,
  }),
] as const;
