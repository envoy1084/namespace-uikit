...
```tsx
import { TimeField } from "@thenamespace/uikit";
```
...
```tsx
import { TimeField, Label, Description, FieldError } from "@thenamespace/uikit";
...
<ComponentPreview name="time-field-custom-render-function" />
...
```tsx
import { TimeField, Label, Description } from "@thenamespace/uikit";
...
- **TimeField.Input** - Input component with segmented editing from `@thenamespace/uikit`
