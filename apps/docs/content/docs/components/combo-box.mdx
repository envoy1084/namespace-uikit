...
links:
  ...
  storybook: Components/Forms/ComboBox
---
...
The ComboBox component uses these CSS classes ([View source styles](https://github.com/thenamespace/uikit/blob/main/packages/uikit/src/styles/components/combo-box.css)):
