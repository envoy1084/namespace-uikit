...
```tsx
import { Dropdown } from "@thenamespace/uikit";
```
...
```tsx
import { Dropdown, Button } from "@thenamespace/uikit";
...
The Dropdown component uses these CSS classes ([View source styles](https://github.com/thenamespace/uikit/blob/main/packages/uikit/src/styles/components/dropdown.css)):
...
- `.menu` - Base menu container ([menu.css](https://github.com/thenamespace/uikit/blob/main/packages/uikit/src/styles/components/menu.css))
  - `[data-slot="separator"]` - Separator elements within the menu

#### MenuItem Classes

- `.menu-item` - Base menu item container ([menu-item.css](https://github.com/thenamespace/uikit/blob/main/packages/uikit/src/styles/components/menu-item.css))
...
- `.menu-section` - Base menu section container ([menu-section.css](https://github.com/thenamespace/uikit/blob/main/packages/uikit/src/styles/components/menu-section.css))
...
```tsx
import { Dropdown, Button, Label } from "@thenamespace/uikit";
