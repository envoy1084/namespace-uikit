...
```tsx
import { ProgressBar, Label } from "@thenamespace/uikit";
```
...
The ProgressBar component uses these CSS classes ([View source styles](https://github.com/thenamespace/uikit/blob/main/packages/uikit/src/styles/components/progress-bar.css)):
