...
const part = (name: string, className?: string) => cn(`widget__${name}`, className);
...
function WidgetRoot({ children, className, ...props }: WidgetRootProps): ReactElement {
  return (
    <Context value>
      <dom.div {...props} className={cn("widget", className)} data-slot="widget">
        {children}
      </dom.div>
    </Context>
  );
...
function WidgetHeader({ children, className, ...props }: WidgetHeaderProps): ReactElement {
  useWidget();
  return (
    <div {...props} className={part("header", className)} data-slot="widget-header">
      {children}
    </div>
  );
}
...
function WidgetTitle({ children, className, ...props }: WidgetTitleProps): ReactElement {
  useWidget();
  return (
    <span {...props} className={part("title", className)} data-slot="widget-title">
      {children}
    </span>
  );
}
...
function WidgetDescription({
  ...
  useWidget();
  return (
    <span {...props} className={part("description", className)} data-slot="widget-description">
      {children}
    </span>
  );
}
...
function WidgetContent({ children, className, ...props }: WidgetContentProps): ReactElement {
  useWidget();
  return (
    <div {...props} className={part("content", className)} data-slot="widget-content">
      {children}
    </div>
  );
}
...
function WidgetFooter({ children, className, ...props }: WidgetFooterProps): ReactElement {
  useWidget();
  return (
    <div {...props} className={part("footer", className)} data-slot="widget-footer">
      {children}
    </div>
  );
}
...
function WidgetLegend({ children, className, ...props }: WidgetLegendProps): ReactElement {
  useWidget();
  return (
    <div {...props} className={part("legend", className)} data-slot="widget-legend">
      {children}
    </div>
  );
}
...
function WidgetLegendItem({
  ...
  useWidget();
  return (
    <div {...props} className={part("legend-item", className)} data-slot="widget-legend-item">
      <span
