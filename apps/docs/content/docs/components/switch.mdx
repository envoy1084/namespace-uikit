...
links:
  ...
  styles: switch.css
  storybook: Components/Forms/Switch
  figma: true
---
...
```tsx
import { Switch, SwitchGroup, Label } from "@thenamespace/uikit";
```
...
```tsx
import { Switch, Description, FieldError } from "@thenamespace/uikit";
...
<ComponentPreview name="switch-custom-render-function" />
...
```tsx
import { Switch, Label } from "@thenamespace/uikit";
...
The Switch component uses these CSS classes ([View source styles](https://github.com/thenamespace/uikit/blob/main/packages/uikit/src/styles/components/switch.css)):
...
The SwitchGroup component uses these CSS classes ([View source styles](https://github.com/thenamespace/uikit/blob/main/packages/uikit/src/styles/components/switch-group.css)):
