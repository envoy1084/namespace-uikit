...
links:
  ...
  styles: surface.css
  storybook: Components/Layout/Surface
---
...
```tsx
import { Surface, Input, TextArea } from "@thenamespace/uikit";
...
The Surface component uses these CSS classes ([View source styles](https://github.com/thenamespace/uikit/blob/main/packages/uikit/src/styles/components/surface.css)):
...
import { SurfaceContext } from "@thenamespace/uikit";
