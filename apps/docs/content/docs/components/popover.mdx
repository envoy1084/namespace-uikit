...
```tsx
import { Popover } from "@thenamespace/uikit";
```
...
<ComponentPreview name="popover-custom-render-function" />
...
```tsx
import { Popover, Button } from "@thenamespace/uikit";
...
The Popover component uses these CSS classes ([View source styles](https://github.com/thenamespace/uikit/blob/main/packages/uikit/src/styles/components/popover.css)):
