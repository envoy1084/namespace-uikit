...
export function NameRegistrationHeader({
  children,
  className,
}: NameRegistrationLayoutProps) {
...
export function NameRegistrationHeading({
  children,
  className,
}: NameRegistrationLayoutProps) {
  const { presentation } = useNameRegistration();
...
export function NameRegistrationBody({
  children,
  className,
}: NameRegistrationLayoutProps) {
  const { presentation } = useNameRegistration();
...
export function NameRegistrationFooter({
  children,
  className,
}: NameRegistrationLayoutProps) {
  const { presentation } = useNameRegistration();
