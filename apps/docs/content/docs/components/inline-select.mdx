...
{/* PRO_DEMO inline-select-default */}
<ComponentPreview name="inline-select-default" />
...
{/* PRO_DEMO inline-select-team-switcher */}
<ComponentPreview name="inline-select-team-switcher" />

## Custom Indicator

{/* PRO_DEMO inline-select-custom-indicator */}
<ComponentPreview name="inline-select-custom-indicator" />

## Multi Select

{/* PRO_DEMO inline-select-multi-select */}
<ComponentPreview name="inline-select-multi-select" />

## Placements

{/* PRO_DEMO inline-select-placements */}
<ComponentPreview name="inline-select-placements" />
