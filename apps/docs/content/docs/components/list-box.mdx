...
```tsx
import { ListBox } from "@thenamespace/uikit";
```
...
```tsx
import { ListBox, Label, Description, Header } from "@thenamespace/uikit";
...
<ComponentPreview name="list-box-custom-render-function" />
...
<ComponentPreview name="list-box-virtualization" />
...
The ListBox component uses these CSS classes ([View source styles](https://github.com/thenamespace/uikit/blob/main/packages/uikit/src/styles/components/list-box.css)):
...
```tsx
import { ListBox, Label, Description } from "@thenamespace/uikit";

<ListBox aria-label="Users" selectionMode="single">
  <ListBox.Item id="1" textValue="Bob">
    <Label>Bob</Label>
    <Description>bob@namespace.com</Description>
  </ListBox.Item>
  <ListBox.Item id="2" textValue="Alice">
    <Label>Alice</Label>
    <Description>alice@namespace.com</Description>
  </ListBox.Item>
</ListBox>;
```
...
```tsx
import { ListBox, Header, Separator } from "@thenamespace/uikit";
...
```tsx
import { ListBox, Selection } from "@thenamespace/uikit";
...
```tsx
import { ListBox, ListBoxItemIndicator } from "@thenamespace/uikit";
...
<ListBox aria-label="Options" selectionMode="multiple">
  <ListBox.Item id="1" textValue="Option 1">
    ...
    <ListBox.ItemIndicator>
      {({ isSelected }) =>
        isSelected ? <Icon icon="hugeicons:check" /> : null
      }
    </ListBox.ItemIndicator>
  </ListBox.Item>
</ListBox>;
