...
links:
  ...
  styles: modal.css
  storybook: Components/Overlays/Modal
---
...
```tsx
import { Modal, Button } from "@thenamespace/uikit";
...
The Modal component uses these CSS classes ([View source styles](https://github.com/thenamespace/uikit/blob/main/packages/uikit/src/styles/components/modal.css)):
