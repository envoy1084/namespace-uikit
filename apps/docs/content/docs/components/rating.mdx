...
{/* DEMO rating-read-only-fractional */}
<ComponentPreview name="rating-read-only-fractional" />

## Render Function

{/* DEMO rating-render-function */}
