...
export const ChainBnbIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path fill="url(#chain_bnb_svg__a)" d="M0 0h32v32H0z" />
    <defs>
      <pattern id="chain_bnb_svg__a" width={1} height={1} patternContentUnits="objectBoundingBox">
        <use xlinkHref="#chain_bnb_svg__b" transform="scale(.0052)" />
      </pattern>
      <image
