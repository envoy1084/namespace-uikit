...
links:
  ...
  storybook: Components/Forms/Autocomplete
---

## Import

```tsx
import { Autocomplete, useFilter } from "@thenamespace/uikit";
```
...
```tsx
import { Autocomplete, SearchField, ListBox } from "@thenamespace/uikit";
...
The Autocomplete component uses these CSS classes ([View source styles](https://github.com/thenamespace/uikit/blob/main/packages/uikit/src/styles/components/autocomplete.css)):
...
```tsx
import { useFilter } from "@thenamespace/uikit";
