...
<ComponentPreview name="checkbox-external-label" />
...
<ComponentPreview name="checkbox-custom-render-function" />
...
The Checkbox component uses these CSS classes ([View source styles](https://github.com/thenamespace/uikit/blob/main/packages/uikit/src/styles/components/checkbox.css)):
