...
{/* PRO_DEMO list-view-selection-modes */}
<ComponentPreview name="list-view-selection-modes" />
...
{/* PRO_DEMO list-view-with-action-bar */}
<ComponentPreview name="list-view-with-action-bar" />
...
{/* PRO_DEMO list-view-disabled */}
<ComponentPreview name="list-view-disabled" />

### Secondary Variant

{/* PRO_DEMO list-view-secondary-variant */}
<ComponentPreview name="list-view-secondary-variant" />
