...
links:
  ...
  styles: select.css
  storybook: Components/Forms/Select
---

## Import

```tsx
import { Select } from "@thenamespace/uikit";
```
...
The Select component uses these CSS classes ([View source styles](https://github.com/thenamespace/uikit/blob/main/packages/uikit/src/styles/components/select.css)):
