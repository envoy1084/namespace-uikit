...
links:
  ...
  styles: slider.css
  storybook: Components/Forms/Slider
---

## Import

```tsx
import { Slider } from "@thenamespace/uikit";
```
...
```tsx
import { Slider, Label } from "@thenamespace/uikit";
...
The Slider component uses these CSS classes ([View source styles](https://github.com/thenamespace/uikit/blob/main/packages/uikit/src/styles/components/slider.css)):
