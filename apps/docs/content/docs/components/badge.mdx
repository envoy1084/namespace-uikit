...
```tsx
import { Badge } from "@thenamespace/uikit";
```
...
> For standalone label usage, use the [Chip](/docs/components/chip) component instead.
...
<ComponentPreview name="badge-with-content" />
...
The Badge component uses these CSS classes ([View source styles](https://github.com/thenamespace/uikit/blob/main/packages/uikit/src/styles/components/badge.css)):
