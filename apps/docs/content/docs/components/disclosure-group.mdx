...
```tsx
import { DisclosureGroup } from "@thenamespace/uikit";
```
...
```tsx
import { DisclosureGroup, Disclosure } from "@thenamespace/uikit";
...
The DisclosureGroup component uses these CSS classes ([View source styles](https://github.com/thenamespace/uikit/blob/main/packages/uikit/src/styles/components/disclosure-group.css)):
