...
const ColorItem = ({ cssVariable, name, variable }: ColorItemProps) => {
  ...
  return (
    <div className="bg-surface shadow-surface flex items-center gap-4 rounded-3xl p-4">
      <div
...
export const AllColors = () => {
  ...
  const calculatedSoftColors: ColorItemProps[] = [
    { name: "Accent Soft", variable: "--color-accent-soft" },
    {
      ...
      variable: "--color-accent-soft-foreground",
    },
    ...
    { name: "Danger Soft", variable: "--color-danger-soft" },
    {
      ...
      variable: "--color-danger-soft-foreground",
    },
    ...
    { name: "Warning Soft", variable: "--color-warning-soft" },
    {
      ...
      variable: "--color-warning-soft-foreground",
    },
    ...
    { name: "Success Soft", variable: "--color-success-soft" },
    {
      ...
      variable: "--color-success-soft-foreground",
    },
  ...
  const calculatedInSurfaceColors: ColorItemProps[] = [
    ...
    {
      name: "On Surface Foreground",
      variable: "--color-on-surface-foreground",
    },
  ...
  const calculatedInSurfaceSecondaryColors: ColorItemProps[] = [
    ...
    {
      name: "On Surface Secondary Foreground",
      variable: "--color-on-surface-secondary-foreground",
    },
    {
      name: "On Surface Secondary Hover",
      variable: "--color-on-surface-secondary-hover",
    },
    {
      name: "On Surface Secondary Focus",
      variable: "--color-on-surface-secondary-focus",
    },
  ];
  ...
  const calculatedInSurfaceTertiaryColors: ColorItemProps[] = [
    ...
    {
      name: "On Surface Tertiary Foreground",
      variable: "--color-on-surface-tertiary-foreground",
    },
    {
      name: "On Surface Tertiary Hover",
      variable: "--color-on-surface-tertiary-hover",
    },
    {
      name: "On Surface Tertiary Focus",
      variable: "--color-on-surface-tertiary-focus",
    },
  ];
    ...
    <div className="mx-auto max-w-4xl p-6">
      <div className="mb-8">
        ...
        <p className="text-muted">
          Namespace UI's color palette with CSS variables and computed values
        </p>
      </div>
...
AllColors.parameters = {
  docs: {
    description: {
      story:
        "A comprehensive overview of all color tokens available in the Namespace UI design system. Each color shows its CSS variable name and computed value.",
    },
  },
};
